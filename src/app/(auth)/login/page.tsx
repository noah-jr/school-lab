...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("admin@jwpub.org");
  ...
  return (
    <div className="auth-container">
      ...
      <Link href="/" className="auth-back">← Voltar à página inicial</Link>
      
      <div className="auth-card">
        <div className="auth-header">
          <div className="auth-icon"><Lock size={20} color="var(--accent)" /></div>
          <h1 className="auth-title">Acesso Restrito</h1>
          <p className="auth-subtitle">EAC — Sistema de Gestão Institucional</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button 
            ...
            disabled={loading}
          >
            {loading ? "A autenticar..." : "Entrar no Sistema"} <ArrowRight size={16} />
          </button>
        </form>
      </div>
